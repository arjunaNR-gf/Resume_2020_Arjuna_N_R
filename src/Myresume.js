...
useEffect(()=>
{
  ...
  return (
    ...
    <div className="my-clg-exy">
       ...
       <div className={disheader?"mobile-header":"header"}>
           <p>Name : ARJUNA N R | Qualification : MCA(cs),BSc(pcm)</p>
    ...
    <div className="my-clg-ex">
        <p className="p1" style={{width:"24%",backgroundColor:"navy",padding:"0.5%",marginTop:"1%"}}>EXPERIENCE</p>
 ...
 <div style={{width:"90%",height:"auto",backgroundColor:"white",border:"2px solid lavender",marginLeft:"1%"}}>
    ...
    <div className="my-clg-exy">
     <p className="p1" style={{width:"16%",backgroundColor:"navy",padding:"0.1%",marginLeft:"1%",marginTop:"1%"}}>HOBIES</p>
     <table>
